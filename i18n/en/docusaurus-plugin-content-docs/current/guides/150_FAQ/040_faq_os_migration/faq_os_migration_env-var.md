...
Referring to [FAQ](/guides/FAQ/faq_software/faq_bash/#ubuntu-initialization), the procedure is as follows.
...
To learn how to restore the initial state, [refer to the FAQ 'Software General'](/guides/FAQ/faq_software/faq_bash/#ubuntu-initialization).
...
### ii) Reinstalling R from a tarball {#r-error-while-loading-shared-libraries#tarball}
...
For more information on commenting out, see ['Questions about behavior at login'](/guides/FAQ/faq_os_migration/faq_os_migration_login#module_load).
