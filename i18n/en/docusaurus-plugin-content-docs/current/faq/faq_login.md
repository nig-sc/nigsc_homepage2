...
As of 7 July 2022, we move the data to a new application system for use ("[July 5, 2022(Monday) New use application system is new](/en/blog/2022-07-05-news_NewApp)").
