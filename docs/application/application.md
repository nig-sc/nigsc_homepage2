...
## 成果報告の提出を求めます
- スパコンを用いた結果または経過について**年度末**に報告を求めます。
- 報告書は原則として公開となっておりますので留意願います。[論文リストのページ](/report/papers_2020)に公開しております。
- スパコンを利用した論文が採択された際には謝辞への記載をお願いします。記載例はトップページの[「謝辞について」](/#謝辞について)をご参照ください。
