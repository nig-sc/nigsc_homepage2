...
- 以下の場合は、「申請者が責任者である、または責任者のアカウント名がわからない」のチェックボックスをクリックしてください。チェックボックスをクリックすると、左図の画面が表示されますので、責任者情報を入力してください。入力したら、「次へ」をクリックしてください。手順は、[<u>FAQをご参照ください</u>](/faq/faq_NewUser_registration#責任者のアカウント名とグループ名に何を入力したら良いのかわかりません)。
