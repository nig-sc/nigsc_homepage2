...
<!-- <a href="https://sc-account.ddbj.nig.ac.jp/application/registration">アカウントの新規登録のページ</a> --> 
[アカウントの新規登録のページ](/blog/2024-10-25-account_system_maintenance) の「アカウント」のページにある「SSH公開鍵」の枠の中をクリックし、command + V を押して、貼り付けます。
