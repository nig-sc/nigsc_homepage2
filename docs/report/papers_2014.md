...
<tr>
    ...
    <td>DDBJ progress report: a new submission system for leading to a correct annotation>
...
<tr>
    ...
    <td>Genome-wide study of KNOX regulatory network reveals brassinosteroid catabolic ge>
...
<tr>
    ...
    <td>Tissue- and stage-dependent dosage compensation on the neo-X chromosome in Drosop>
...
<tr>
    ...
    <td>鈴木 穣</td>
    <td>Yutaka Suzuki</td>
    <td>Interactive transcriptome analysis of malaria patients and infecting Plasmodium f>
...
<tr>
    ...
    <td>Genome-wide quantification of homeolog expression ratio revealed nonstochastic ge>
...
<tr>
    ...
    <td>Bidirectional promoters are the major source of gene activation-associated non-co>
...
<tr>
    ...
    <td>A Bead-based Normalization for Uniform Sequencing depth (BeNUS) protocol for mult>
...
<tr>
    ...
    <td>Genome-wide marker development for the wheat D genome based on single nucleotide >
...
<tr>
    ...
    <td>Performance comparison of second- and third-generation sequencers using a bacteri>
...
<tr>
    ...
    <td>Extreme expansion of the olfactory receptor gene repertoire in African elephants >
...
<tr>
    ...
    <td>阿部 貴志</td>
    <td>Takashi Abe</td>
    <td>Visualization of genome signatures of eukaryote genomes by batch-learning self-or>
...
<tr>
    ...
    <td>中川 草</td>
    <td>So Nakagawa</td>
    <td>Construction of an infectious clone of simian foamy virus of Japanese macaque (SF>
...
<tr>
    ...
    <td>Draft Genome Sequence of Weissella oryzae SG25T, Isolated from Fermented Rice Gra>
...
<tr>
    ...
    <td>MetaMetaDB: a database and analytic system for investigating microbial habitabili>
...
<tr>
    ...
    <td>岩崎 渉</td>
    <td>Wataru Iwasaki</td>
    <td>CLOCK-controlled polyphonic regulation of circadian rhythms through canonical and>
...
<tr>
    ...
    <td>岩崎 渉</td>
    <td>Wataru Iwasaki</td>
    <td>Parallel selection on gene copy number variations through evolution of three-spin>
...
<tr>
    ...
    <td>Discovery of osmotic sensitive transcription factors in fish intestine via a tran>
...
<tr>
    ...
    <td>Arginine side chains as a dispersant for individual single-wall carbon nanotubes.>
...
<tr>
    ...
    <td>亀田 倫史</td>
    <td>Tomoshi Kameda</td>
    <td>Mechanism of protein desorption from 4-mercaptoethylpyridine resins by arginine s>
...
<tr>
    ...
    <td>河合 洋介</td>
    <td>Yosuke Kawai</td>
    <td>Evolution and diversity of the 2-oxoglutarate-dependent dioxygenase superfamily i>
...
<tr>
    ...
    <td>河合 洋介</td>
    <td>Yosuke Kawai</td>
    <td>Expansion of specialized metabolism-related superfamily genes via whole genome du>
...
<tr>
    ...
    <td>Heterochromatin dynamics during the differentiation process revealed by the DNA m>
...
<tr>
    ...
    <td>前原 一満</td>
    <td>Kazumitsu Maehara</td>
    <td>Regulation of RNA polymerase II activation by histone acetylation in single livin>
...
<tr>
    ...
    <td>門田 有希</td>
    <td>Yuki Monden</td>
    <td>Efficient DNA fingerprinting based on the targeted sequencing of active retrotran>
...
<tr>
    ...
    <td>門田 有希</td>
    <td>Yuki Monden</td>
    <td>Efficient screening of long terminal repeat retrotransposons that show high inser>
...
<tr>
    ...
    <td>門田 有希</td>
    <td>Yuki Monden</td>
    <td>Application of iPBS in high-throughput sequencing for the development of retrotra>
...
<tr>
    ...
    <td>門田 有希</td>
    <td>Yuki Monden</td>
    <td>新規活性型レトロトランスポゾンTriRe-1の挿入多型を利用したHigh-throughputなコムギ[>
...
<tr>
    ...
    <td>城地 保昌</td>
    <td>Yasumasa Joti</td>
    <td>Chromatin structure revealed by X-ray scattering analysis and computational model>
...
<tr>
    ...
    <td>Whole-Genome Sequence of Burkholderia sp. Strain RPE67, a Bacterial Gut Symbiont >
...
<tr>
    ...
    <td>Improvement of domain-level ortholog clustering by optimizing domain-specific sum>
...
<tr>
    ...
    <td>笠原 浩太</td>
    <td>Kota Kasahara</td>
    <td>A novel approach of dynamic cross correlation analysis on molecular dynamics simu>
...
<tr>
    ...
    <td>Distribution and evolution of glycoside hydrolase family 45 cellulases in nematod>
...
<tr>
    ...
    <td>菊地 泰生</td>
    <td>Taisei Kikuchi</td>
    <td>Summarizing specific profiles in Illumina sequencing from whole-genome amplified >
...
<tr>
    ...
    <td>佐藤 賢二</td>
    <td>Kenji Satou</td>
    <td>D-IMPACT: A Data Preprocessing Algorithm to Improve the Performance of Clustering>
...
<tr>
    ...
    <td>佐藤 賢二</td>
    <td>Kenji Satou</td>
    <td>Predicting residue contacts for protein-protein interactions by integration of mu>
...
<tr>
    ...
    <td>飯田 哲史</td>
    <td>Tetsushi Iida</td>
    <td>Mudi, a web tool for identifying mutations by bioinformatics analysis of whole-ge>
...
<tr>
    ...
    <td>Phytochrome controls alternative splicing to mediate light responses in Arabidops>
...
<tr>
    ...
    <td>黒田 真也</td>
    <td>Shinya Kuroda</td>
    <td>Reconstruction of insulin signal flow from phosphoproteome and metabolome data.</>
...
<tr>
    ...
    <td>Comparative genomics of Taphrina fungi causing varying degrees of tumorous deform>
...
<tr>
    ...
    <td>Isheng J Tsai</td>
    <td>The genome of the sparganosis tapeworm Spirometra erinaceieuropaei isolated from >
...
<tr>
    ...
    <td>Tsai Isheng Jason</td>
    <td>Isheng J Tsai</td>
    <td>Assessment of helminth biodiversity in wild rats using 18S rDNA based metagenomic>
...
<tr>
    ...
    <td>Tsai Isheng Jason</td>
    <td>Isheng J Tsai</td>
    <td>Whipworm genome and dual-species transcriptome analyses provide molecular insight>
...
<tr>
    ...
    <td>Genome-wide single nucleotide polymorphisms and insertion-deletions of Oryza sati>
...
<tr>
    ...
    <td>Kuppuraj Gopi</td>
    <td>Gopi Kuppuraj</td>
    <td>Conformational behavior of flavin adenine dinucleotide: conserved stereochemistry>
