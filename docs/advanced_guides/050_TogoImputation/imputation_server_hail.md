...
## Guacamole環境への接続 {#connect-nig-guacamole}
...
### miniconda のインストール {#installing-miniconda}
...
### conda-forge を用いた conda 環境の構築 {#create-conda-env}
...
### Hail と Jupyter のインストール {#installing-jupyter-and-hail}
...
## Jupyter Notebook の起動 {#launching-jupyter-notebook}
...
## Hailの起動確認 {#checking-hail-startup}
...
## インピューテーション結果を hail の入力とし PRS 計算の行うノートブック {#notebook-prs-calculation-hail-imputation}
